    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                >
                    <BeconStudent></BeconStudent>
                </div>
                <div
                    class="tab-pane fade"
                    :class="{ active: teacherActive, show: teacherActive }"
                    id="pills-teacher"
                    role="tabpanel"
                    aria-labelledby="pills-teacher-tab"
                >
                    <BeconTeacher></BeconTeacher>
                </div>
            </div>
        </div>
    </div>
...
import BeconStudent from "./BeconStudent";
import BeconTeacher from "./BeconTeacher";
export default {
    components: {
        BeconStudent,
        BeconTeacher,
