<template>
    <div class="container mt-5">
        <!-- {{JSON.stringify(teacherDataSort)}} -->
        <!-- {{teacherDataSort}} -->
                    ...
                    >
                        ...
                        <tbody>
                            <tr v-for="item in pageOfItems" :key="item.id">
                                ...
                                <td>{{ item.phone }}</td>
                                <td>
                                    <p v-for="n in item.department" :key="n.id">
                                        {{ n.name }}
                                    </p>
                                </td>
                                <td>{{ item.mac }}</td>
    ...
    methods: {
        ...
        xlsxExport() {
            if (this.teacher_type == 1) {
                console.log("becon");
                var url = "teacher/becon/export";
            } else if (this.teacher_type == 2) {
                console.log("face");
                var url = "teacher/face/export";
            } else if (this.teacher_type == 3) {
                console.log("becon_face");
                var url = "teacher/becon_face/export";
            }
        ...
        sortData(type) {
            ...
            this.teacherDataSort = this.teacherDataSort.sort(function (a, b) {
                ...
                // }
                if (type === "name" || "phone" || "account" || "department") {
                    // console.log("time");
                    if (vm.isReverse) {
