...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'git@gitlab.com:SmartCube/signature_system.git',
    ...
    */
    ...
    'hosts' => [
        'production' => [
            'stage' => 'production',
            'hostname' => '54.250.93.44',
            'deploy_path' => '/var/www/signature_system',
            'user' => 'deployer',
            'branch' => 'master',
        ],
        'staging' => [
            'stage' => 'staging',
            'hostname' => 'ec2-54-248-206-163.ap-northeast-1.compute.amazonaws.com',
            'deploy_path' => '/var/www/IMS',
            'user' => 'deployer',
            'branch' => 'develop',
        ],
    ],
